...
export function TimelineSection({
  ...
  return (
    <TimelineSectionContext.Provider value={{ callbacks, addCallback }}>
      ...
      >
        <div className="dr-layout-grid-inner dt:h-dvh dt:dr-max-h-900 relative ">
          <div className="col-span-4 flex flex-col dr-pt-80 dt:dr-pt-165 max-dt:dr-pb-16 max-dt:h-dvh z-1">
